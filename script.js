...
function popBalloon(b) {
    ...
    if (poppedBalloons === 4) {
        ...
        setTimeout(() => document.getElementById('btn-next-balloons').classList.remove('hidden'), 1000);
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('final-message-text').textContent = 
        `Happy Birthday, ${recipientName}! 💖 You deserve endless smiles, love, and magic moments today!`;
});
